...
# path = "/Users/yezhouli/Desktop/Python/GrabCut/assets/scarf.jpg"
# src = cv2.imread(path)
# cv2.imshow('src', src)

# # r = cv2.selectROI('input', src, False)
...
# maks2 = np.where( (mask==1) | (mask==3), 255, 0).astype('unit8')
...
img = cv2.imread('/Users/yezhouli/Desktop/Python/GrabCut/assets/scarf.jpg')
